...
/**
 * Реализация сортировщика строк по возрастанию.
 */
public class SorterStringAsc extends Sorter<String> {
    public SorterStringAsc(List<Task> tasks, List<String> lines, Writer writer, String previousLine) {
