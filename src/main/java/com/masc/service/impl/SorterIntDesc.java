...
/**
 * Реализация сортировщика целых чисел по убыванию.
 */
public class SorterIntDesc extends Sorter<Integer> {
    public SorterIntDesc(List<Task> tasks, List<Integer> integers, Writer writer, Integer previousInt) {
